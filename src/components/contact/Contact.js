...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_cqn65sq', 'template_wpxxxys', form.current, 'DaiGbhHqN3GlsEBTt')
      e.target.reset();
  };
  return (
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">ankitkumar01121@gmail.com</span>
                        <a href="mail:user@gmail.com.com" className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">Ankit Kumar</span>
                        <a href="#" className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                </div>
            </div>
